...
public partial class Default6 : System.Web.UI.Page
{
    ...
    {
        if (TextBox1.Text == "" || TextBox2.Text == "" || DropDownList1.Text == ""||TextBox5.Text==""||TextBox3.Text == "" ||TextBox4.Text == "" || !FileUpload1.HasFile || !FileUpload2.HasFile || !FileUpload3.HasFile || !FileUpload4.HasFile || TextBox16.Text == "" || TextBox17.Text == "" || TextBox18.Text == "" || TextBox19.Text == "" || TextBox20.Text == "")
        {
        ...
        else
        {
            ...
            cmd = new SqlCommand("Insert into room (title,id,type,des,amt,img1,img2,img3,img4,a1,a2,a3,a4,a5,nor) values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + DropDownList1.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','"  + pic1 + "','" + pic2 + "','" + pic3 + "','" + pic4 + "','" + TextBox16.Text + "','" + TextBox17.Text + "','" + TextBox18.Text + "','" + TextBox19.Text + "','" + TextBox20.Text + "','" + TextBox5.Text + "')", cn);
            cmd.ExecuteNonQuery();
            cn.Close();
