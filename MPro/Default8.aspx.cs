...
public partial class Default8 : System.Web.UI.Page
{
    ...
    protected void Wizard1_FinishButtonClick(object sender, WizardNavigationEventArgs e)
    {
        ...
        else
        {
            ...
            cmd = new SqlCommand("Insert into hall values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + DropDownList1.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + pic1 + "','" + pic2 + "','" + pic3 + "','" + pic4 + "','" + TextBox5.Text + "','" + TextBox16.Text + "','" + TextBox17.Text + "','" + TextBox18.Text + "','" + TextBox19.Text + "','" + TextBox20.Text + "')", cn);
            cmd.ExecuteNonQuery();
            cn.Close();
